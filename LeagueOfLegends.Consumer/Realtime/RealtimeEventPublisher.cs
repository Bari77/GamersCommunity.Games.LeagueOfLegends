...
using LeagueOfLegends.Consumer.Serialization;
...
public sealed class RealtimeEventPublisher(IOptions<RabbitMQSettings> opts, ILogger logger)
    : IRealtimeEventPublisher, IAsyncDisposable
{
